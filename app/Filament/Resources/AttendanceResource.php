...
class AttendanceResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                ->required()
                ->disabled(fn (?Attendance $record) => $record !== null),
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('status')
                    ...
                    ->icon(fn(string $state): string => match ($state) {
                        'Hadir' => 'heroicon-s-check-badge',
                        'Alpha' => 'heroicon-s-x-circle',
                        'Sakit' => 'heroicon-s-exclamation-triangle',
    ...
    public static function getPages(): array
    {
        return [
            ...
            'bulk' => Pages\CreateBulkAttendance::route('/bulk'),
